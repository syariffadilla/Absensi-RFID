                  ...
                  <form  method="POST" action="{{ route('login') }}" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" @error('email') is-invalid @enderror" placeholder="Please Input Your Email" name="email" required autocomplete="email" autofocus class="form-control" id="yourUsername" required>
